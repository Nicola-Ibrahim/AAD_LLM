...
- **Total Evaluated Pairwise Contests ($N$):** `60`
- **🟢 LLaMEA Statistically Significant Wins ($p_{\text{FDR}} < 0.05, \hat{A}_{12} > 0.5$):** **`8`** (13.3%)
- **🔴 Classical Baseline Significant Wins ($p_{\text{FDR}} < 0.05, \hat{A}_{12} < 0.5$):** **`21`** (35.0%)
- **⚪ Ties / Equivalent ($p_{\text{FDR}} \ge 0.05$):** **`31`** (51.7%)
...
| **Figure D** | Dolan-Moré Performance Profiles $\rho_s(\tau)$ | At $\tau=1$ (zero-slack), **PSO** leads with $\rho_s(1) = 76.2%$ problem coverage. | [`dolan_more_profiles.png`](file:///Users/nicolaibrahim/Desktop/proj/AAD_LLM/results/figures/advanced/dolan_more_profiles.png) |
...
| 2D | 0.0 | **Sphere (f1)** | Separable | 5 | 107.445 | 2.55e-22 | 🟢 **Yes** |
...
| :--- | :--- | :---: | :---: | :---: | :---: | :--- |
| **Sphere (f1)** | Separable | 12 | 0 | 6 | 6 | 🔴 Baseline Advantage |
...
| :---: | :---: | :--- | :--- | :--- | :---: | :---: | :---: | :---: | :---: | :--- |
| 2D | 0.0 | **Sphere (f1)** | LLaMEA_Evolved | DE | 1.80e+01 | 0.00e+00 | 6.73e-08 | 2.03e-06 | 0.000 | **DE Wins** |
| 2D | 0.0 | **Sphere (f1)** | LLaMEA_Evolved | CMAES | 1.80e+01 | 0.00e+00 | 6.73e-08 | 2.03e-06 | 0.000 | **CMAES Wins** |
| 2D | 0.0 | **Sphere (f1)** | LLaMEA_Evolved | PSO | 1.80e+01 | 0.00e+00 | 6.73e-08 | 2.03e-06 | 0.000 | **PSO Wins** |
| 2D | 0.05 | **Sphere (f1)** | LLaMEA_Baseline | DE | 1.98e+01 | 2.55e-02 | 1.83e-04 | 8.19e-04 | 0.000 | **DE Wins** |
| 2D | 0.05 | **Sphere (f1)** | LLaMEA_Baseline | CMAES | 1.98e+01 | 0.00e+00 | 6.39e-05 | 3.68e-04 | 0.000 | **CMAES Wins** |
| 2D | 0.05 | **Sphere (f1)** | LLaMEA_Baseline | PSO | 1.98e+01 | 0.00e+00 | 6.39e-05 | 3.68e-04 | 0.000 | **PSO Wins** |
| 2D | 0.0 | **Rosenbrock (f8)** | LLaMEA_Baseline | DE | 8.47e+03 | 5.00e-11 | 1.45e-04 | 7.98e-04 | 0.000 | **DE Wins** |
| 2D | 0.0 | **Rosenbrock (f8)** | LLaMEA_Baseline | CMAES | 8.47e+03 | 0.00e+00 | 5.51e-05 | 3.68e-04 | 0.000 | **CMAES Wins** |
| 2D | 0.0 | **Rosenbrock (f8)** | LLaMEA_Baseline | PSO | 8.47e+03 | 0.00e+00 | 5.51e-05 | 3.68e-04 | 0.000 | **PSO Wins** |
| 2D | 0.05 | **Rosenbrock (f8)** | LLaMEA_Baseline | DE | 0.00e+00 | 5.57e-03 | 6.39e-05 | 3.68e-04 | 1.000 | **LLaMEA_Baseline Wins** |
| 3D | 0.0 | **Rosenbrock (f8)** | LLaMEA_Baseline | DE | 1.86e+04 | 3.00e-10 | 1.77e-04 | 8.19e-04 | 0.000 | **DE Wins** |
| 3D | 0.0 | **Rosenbrock (f8)** | LLaMEA_Baseline | CMAES | 1.86e+04 | 0.00e+00 | 6.34e-05 | 3.68e-04 | 0.000 | **CMAES Wins** |
| 3D | 0.0 | **Rosenbrock (f8)** | LLaMEA_Baseline | PSO | 1.86e+04 | 0.00e+00 | 6.34e-05 | 3.68e-04 | 0.000 | **PSO Wins** |
| 3D | 0.05 | **Rosenbrock (f8)** | LLaMEA_Baseline | DE | 2.00e-10 | 9.44e-02 | 1.77e-04 | 8.19e-04 | 1.000 | **LLaMEA_Baseline Wins** |
| 3D | 0.05 | **Rosenbrock (f8)** | LLaMEA_Baseline | CMAES | 2.00e-10 | 0.00e+00 | 4.59e-03 | 1.26e-02 | 0.145 | **CMAES Wins** |
| 2D | 0.0 | **Discus (f11)** | LLaMEA_Baseline | DE | 0.00e+00 | 2.00e-03 | 6.39e-05 | 3.68e-04 | 1.000 | **LLaMEA_Baseline Wins** |
| 2D | 0.05 | **Discus (f11)** | LLaMEA_Baseline | PSO | 6.14e+03 | 0.00e+00 | 2.04e-03 | 6.84e-03 | 0.100 | **PSO Wins** |
| 3D | 0.0 | **Discus (f11)** | LLaMEA_Baseline | DE | 0.00e+00 | 4.42e-03 | 6.39e-05 | 3.68e-04 | 1.000 | **LLaMEA_Baseline Wins** |
| 3D | 0.05 | **Discus (f11)** | LLaMEA_Baseline | CMAES | 5.25e-04 | 0.00e+00 | 7.56e-04 | 3.16e-03 | 0.070 | **CMAES Wins** |
| 2D | 0.0 | **Rastrigin (f15)** | LLaMEA_Baseline | CMAES | 1.15e-02 | 3.33e+00 | 1.81e-04 | 8.19e-04 | 1.000 | **LLaMEA_Baseline Wins** |
| 2D | 0.0 | **Rastrigin (f15)** | LLaMEA_Baseline | PSO | 1.15e-02 | 0.00e+00 | 2.12e-02 | 4.76e-02 | 0.200 | **PSO Wins** |
| 2D | 0.05 | **Rastrigin (f15)** | LLaMEA_Baseline | DE | 1.64e-05 | 2.43e+00 | 3.61e-03 | 1.07e-02 | 0.890 | **LLaMEA_Baseline Wins** |
| 2D | 0.05 | **Rastrigin (f15)** | LLaMEA_Baseline | PSO | 1.64e-05 | 0.00e+00 | 1.75e-03 | 6.03e-03 | 0.100 | **PSO Wins** |
| 3D | 0.0 | **Rastrigin (f15)** | LLaMEA_Baseline | DE | 1.74e-02 | 3.48e+00 | 2.83e-03 | 8.77e-03 | 0.900 | **LLaMEA_Baseline Wins** |
| 3D | 0.0 | **Rastrigin (f15)** | LLaMEA_Baseline | CMAES | 1.74e-02 | 2.98e+00 | 1.82e-04 | 8.19e-04 | 1.000 | **LLaMEA_Baseline Wins** |
| 2D | 0.0 | **Gallagher 101 Peaks (f21)** | LLaMEA_Baseline | DE | 1.94e+00 | 9.40e-07 | 4.57e-03 | 1.26e-02 | 0.120 | **DE Wins** |
| 2D | 0.0 | **Gallagher 101 Peaks (f21)** | LLaMEA_Baseline | CMAES | 1.94e+00 | 4.38e-01 | 1.52e-02 | 3.67e-02 | 0.175 | **CMAES Wins** |
| 2D | 0.0 | **Gallagher 101 Peaks (f21)** | LLaMEA_Baseline | PSO | 1.94e+00 | 0.00e+00 | 5.63e-04 | 2.43e-03 | 0.060 | **PSO Wins** |
| 3D | 0.0 | **Gallagher 101 Peaks (f21)** | LLaMEA_Baseline | PSO | 1.25e+00 | 6.92e-01 | 6.85e-03 | 1.80e-02 | 0.140 | **PSO Wins** |
...
| :--- | :--- | :---: | :---: | :--- |
| **Sphere (f1)** | Separable | +6.64 | +10.34 | 🟢 **Resilient**: Precision remains intact despite stochastic perturbation |
