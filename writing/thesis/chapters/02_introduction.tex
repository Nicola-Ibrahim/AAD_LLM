...
\begin{figure}[htbp]
    ...
    \caption{High-level view of the closed-loop Automated Algorithm Design process investigated in this thesis. The LLM generates executable optimization heuristics, which are evaluated in a benchmark environment and used to provide feedback for subsequent generations.}
