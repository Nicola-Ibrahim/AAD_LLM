...
\cite{LLaMEA2024}. Runtime errors are handled explicitly: if an evaluation
fails, the candidate is assigned the worst fitness value in the original
maximization formulation. The feedback therefore allows the LLM to use both
performance information and execution errors when modifying or redesigning
an algorithm.
...
algorithms under deterministic or otherwise controlled evaluation conditions.
The comparison in Table~\ref{tab:llm_aad_comparison} shows that existing
