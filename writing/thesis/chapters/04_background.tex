...
\textcolor{red}{\cite{Wolpert1997}}. The characteristics of the optimization
...
structures \textcolor{red}{\cite{BBOB2009}}. The suite is integrated into
...
\begin{table}[htbp]
\centering
\caption{Taxonomy of the 24 Continuous Black-Box Optimization Benchmark (BBOB) Functions \textcolor{red}{\cite{BBOB2009}}.}
...
2 & $f_6 - f_9$ & Low/Moderate Conditioning & \textcolor{yellow}{Functions with low or moderate conditioning, including both unimodal and multimodal structures.} \\
...
\textcolor{red}{Battery-management studies provide examples of optimization and
...
\textcolor{yellow}{\cite{Hansen2009Noisy}}:
...
\textcolor{yellow}{These distributions provide generic examples of fitness-noise
models. The exact noise definitions used in benchmark suites can differ from
these simple additive formulations.} Uniform noise limits the disturbance to
a fixed range, whereas Cauchy noise can produce occasional large deviations
...
The consequences depend on the optimization method. \textcolor{yellow}{Direct
...
\cite{ArnoldB03,Arnold2003}.} \textcolor{yellow}{For direct-search methods,
...
\textcolor{yellow}{\cite{Jin2005,Hansen2009Noisy}}. Noise can therefore
...
\toprule
\textbf{Framework} & \textbf{Output Modality} & \textbf{Search Space} & \textbf{Feedback Type} & \textbf{Reported Evaluation Setting} \\
\midrule
FunSearch \cite{Romera2023} & Program Skeletons & \textcolor{red}{Program Space} & Score Metrics & \textcolor{yellow}{Deterministic benchmark evaluation} \\
EvoLLM \cite{Lange2024} & Coordinate Vectors & Continuous & Point Distributions & \textcolor{yellow}{Numerical optimization evaluation} \\
EvoPrompt \cite{Guo2023} & Prompt Strings & \textcolor{red}{Prompt Space} & Evolutionary Score & \textcolor{yellow}{Task-dependent evaluation} \\
EoH \cite{Liu2024} & Code Blocks & \textcolor{red}{Program Space} & Reflective Prompts & \textcolor{yellow}{Reported deterministic evaluation} \\
AEL \cite{AEL2024} & Code Blocks & \textcolor{red}{Program Space} & Evolutionary Crossover & \textcolor{yellow}{Reported deterministic evaluation} \\
ReEvo \cite{ReEvo2024} & Code Blocks & \textcolor{red}{Program Space} & AST \& Crossover & \textcolor{yellow}{Reported deterministic evaluation} \\
AutoEP \cite{AutoEP2026} & \textcolor{red}{Hyperparameter Strategies} & \textcolor{red}{Structured Parameter Space} & Zero-Shot ELA Features & \textcolor{yellow}{Controlled benchmark evaluation} \\
LLaMEA-SAGE \cite{LLaMEASAGE2026} & Python Classes & \textcolor{red}{Program Space} & AST + XAI Scaffolding & \textcolor{yellow}{Noiseless benchmark evaluation} \\
LLaMEA-BO \cite{LLaMEABO2025} & Python Classes & \textcolor{red}{Program Space} & Surrogate Scores & \textcolor{yellow}{Benchmark evaluation} \\
LLaMEA \cite{LLaMEA2024} & Python Classes & \textcolor{red}{Program Space} & Tracebacks + Score & \textcolor{yellow}{Noiseless benchmark evaluation} \\
\textbf{This Thesis} & \textbf{Python Classes} & \textbf{Program Space} & \textbf{Tracebacks + Scaled Score} & \textbf{Stochastic BBOB evaluation} \\
\bottomrule
\end{tabularx}
\end{table}
...
(ELA) features and uses them to guide \textcolor{red}{hyperparameter
configuration and algorithm control} \cite{AutoEP2026}. This gives the model
information about the characteristics of the optimization problem before a
candidate \textcolor{red}{configuration or control strategy} is generated.
...
instruction. \textcolor{yellow}{Their direct use as variation mechanisms for
continuous optimization algorithm synthesis under stochastic fitness is not
the focus of the reported evaluations and therefore does not establish their
...
Table~\ref{tab:llm_aad_comparison} \textcolor{yellow}{primarily report
evaluations under deterministic or otherwise controlled benchmark
conditions}. Consequently, the effect of stochastic fitness on the
evolutionary selection process used by these systems remains less explored.
...
\textcolor{yellow}{For the discussion in this thesis, the generation context
...
\textcolor{yellow}{This notation is a compact representation used in this
thesis rather than a formal notation introduced by the original LLaMEA
paper.}
...
by the evaluation range. \textcolor{yellow}{In the original LLaMEA formulation,
...
defined. \textcolor{red}{For the original LLaMEA AOCC formulation, higher
...
LLM-based AAD frameworks reviewed in this chapter
\textcolor{yellow}{primarily report evaluations under deterministic or
otherwise controlled benchmark conditions}. The comparison in
Table~\ref{tab:llm_aad_comparison} shows that existing
